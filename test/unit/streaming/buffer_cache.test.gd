...
func test_put_data():
	var data = [1, 52, 21]
	buffer.put_data(PackedByteArray(data), Vector2(0, 2))
...
func test_contiguous_data_from_start():
	buffer.put_data(PackedByteArray([0, 1, 2]), Vector2(0, 2))
	buffer.put_data(PackedByteArray([3, 44, 215]), Vector2(3, 5))
	buffer.put_data(PackedByteArray([6, 72, 8]), Vector2(6, 8))
	assert_eq(buffer.ranges.size(), 1)
...
func test_contiguous_data_from_middle():
	buffer.put_data(PackedByteArray([0, 1, 2]), Vector2(5, 7))
	buffer.put_data(PackedByteArray([3, 44, 215]), Vector2(8, 10))
	buffer.put_data(PackedByteArray([6, 72, 8]), Vector2(11, 13))
	assert_eq(buffer.ranges.size(), 1)
...
func test_overlapping_data_from_start():
	buffer.put_data(PackedByteArray([0]), Vector2(0, 0))
	buffer.put_data(PackedByteArray([1, 1]), Vector2(0, 1))
	buffer.put_data(PackedByteArray([2, 2, 2]), Vector2(1, 3))
	assert_eq(buffer.ranges.size(), 1)
...
func test_overlapping_data_from_middle():
	buffer.put_data(PackedByteArray([0]), Vector2(1, 1))
	buffer.put_data(PackedByteArray([1, 1]), Vector2(1, 2))
	buffer.put_data(PackedByteArray([2, 2, 2]), Vector2(2, 4))
	assert_eq(buffer.ranges.size(), 1)
...
func test_non_contiguos_data():
	buffer.put_data(PackedByteArray([5, 5, 5]), Vector2(5, 7))
	buffer.put_data(PackedByteArray([1, 1, 1]), Vector2(1, 3))
	buffer.put_data(PackedByteArray([9, 9, 9]), Vector2(9, 11))
...
func test_partially_overlapping_two_ranges():
	buffer.put_data(PackedByteArray([5, 6, 7]), Vector2(5, 7))
	buffer.put_data(PackedByteArray([1, 2, 3]), Vector2(1, 3))
	buffer.put_data(PackedByteArray([3, 4, 5]), Vector2(3, 5))
...
func test_get_missing_ranges_non_overlapping_or_adjacent():
	buffer.put_data(PackedByteArray([4, 5, 6]), Vector2(4, 6))
	buffer.put_data(PackedByteArray([12, 13, 14]), Vector2(12, 14))
	assert_eq(buffer.get_missing_ranges(0, 0) as Array, [Vector2(0, 0)])
...
func test_get_missing_ranges_adjacent():
	buffer.put_data(PackedByteArray([1, 2, 3]), Vector2(1, 3))
	buffer.put_data(PackedByteArray([7, 8, 9]), Vector2(7, 9))
	assert_eq(buffer.get_missing_ranges(0, 0) as Array, [Vector2(0, 0)])
...
func test_invert_missing_ranges():
	buffer.put_data(PackedByteArray([1, 2, 3]), Vector2(1, 3))
	buffer.put_data(PackedByteArray([5, 6, 7]), Vector2(5, 7))
	buffer.put_data(PackedByteArray([20, 21, 22]), Vector2(20, 22))
